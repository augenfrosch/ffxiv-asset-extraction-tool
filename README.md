...
The [Rust](https://rust-lang.org/) toolchain is required to build the tool. Only version `1.95.0` is currently verified to work (although other recent versions will likely work as well).
